    ...
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            OpCode::Ne { dest, left, right } => {
                write!(f, "NE       R{} R{} R{}", dest, left, right)
            }
            ...
            OpCode::Le { dest, left, right } => {
                write!(f, "LE       R{} R{} R{}", dest, left, right)
            }
            ...
            OpCode::NewTable {
                ...
                size_array,
                size_hash,
            } => write!(f, "NEWTABLE R{} {} {}", dest, size_array, size_hash),
            OpCode::GetTable { dest, table, key } => {
                write!(f, "GETTABLE R{} R{} R{}", dest, table, key)
            }
            ...
            OpCode::Call {
                ...
                argc,
                retc,
            } => write!(f, "CALL     R{} {} {}", func_reg, argc, retc),
